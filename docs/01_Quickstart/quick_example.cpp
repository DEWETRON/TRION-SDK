...
int main(int argc, char* argv[])
{
    ...
    // Step 2: Enable AI0 channel on board 1, disable all other
    ...
    // Step 3: Configure acquisition properties
    ...
    // Step 6: Measurement loop and sample processing
    ...
    // Step 8: Free boards and unload SDK
