.. TRION-SDK documentation master file

.. Sphinx and reStructuredText documentation:
...
TRION-SDK is a set of libraries and tools that allow to access TRION and TRION3 based measurement
devices:
...
.. note:: TRION-SDK is not a complete measurement application and does not provide one.
...
.. toctree::
   ...
   001_Introduction/Introduction
   01_Quickstart/Quickstart
   02_ChannelTypes/ChannelTypes
   03_DataAcquisition/DataAcquisition
